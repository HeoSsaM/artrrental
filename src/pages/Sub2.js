...
const Sub2 = ({ pic,  showButton,  btnDataClick }) => {
  return (
    <div className='container author'>
        ...
        <Routes>
          <Route path='/' element={<AuthorInfo pic={pic}  showButton={showButton} />}></Route>
          <Route path='sub2-1' element={<AuthorInfo pic={pic} showButton={showButton} btnDataClick={ btnDataClick}/>}></Route> 
